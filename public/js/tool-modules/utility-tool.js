...
"random-string-generator":v=>{const n=Math.max(1,Number(v)||16),chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";return Array.from(crypto.getRandomValues(new Uint8Array(n)),b=>chars[b%chars.length]).join("")},
...
"random-password-generator":()=>Array.from(crypto.getRandomValues(new Uint8Array(20)),b=>"ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz23456789!@#$%&*"[b%66]).join(""),
